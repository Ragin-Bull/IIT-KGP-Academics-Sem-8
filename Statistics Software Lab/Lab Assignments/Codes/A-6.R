...
generateMoments <- function(data, order) {
  ...
  noncentralMoments <- sum((data)^order) / n
...
printNewResults <- function() {
  ...
  cat(freqTable)
  cat("\nThe First Non-Central Moment is as follows: \n")
  cat(firstMoment$noncentral)
  cat("\nThe Second Non-Central Moment is as follows: \n")
  cat(secondMoment$noncentral)
  cat("\nThe Third Non-Central Moment is as follows: \n")
  cat(thirdMoment$noncentral)
  cat("\nThe Fourth Non-Central Moment is as follows: \n")
  cat(fourthMoment$noncentral)

  cat("\nThe First Central Moment is as follows: \n")
  cat(firstMoment$central)
  cat("\nThe Second Central Moment is as follows: \n")
  cat(secondMoment$central)
  cat("\nThe Third Central Moment is as follows: \n")
  cat(thirdMoment$central)
  cat("\nThe Fourth Central Moment is as follows: \n")
  cat(fourthMoment$central)
